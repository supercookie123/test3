#### March 31, 2022, may thurner/ illiac vein stenting project in meta analysis ####
...
setwd("C:/Users/admin/Dropbox/Erben Young project/20220331_meta_iliac_vein_stenting")
...
NIVL.sc$group <-"NIVL"
PIVL.sc<-data.frame(
  author=c("Zhu Q","Jiang C","Zhu Y","Fanatsu A","Yonghua B","Hue G","Zhu Q","Matsuda A","Blanch Alerlany"),
  NumPositive=c("6","99","12", "1","4","4","4","2","1"),
  NumSample  =c("111","300","19","60","46","59","85","24","107")   )
PIVL.sc$group <-"PIVL"
